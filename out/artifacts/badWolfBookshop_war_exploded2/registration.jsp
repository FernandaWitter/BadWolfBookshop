            ...
            <ul class="main-navigation">
                <li>
                    <div class="m-l-20 m-r-20">
                        <a href="index.jsp" class="parent">
                            <button type="button" style="background: transparent"><span>IN&Iacute;CIO</span></button>
                        </a>
                    </div>
                </li>
                <li>
                    <div class="m-l-20 m-r-20">
                        <form action="search" method="get">
                            ...
                            <a class="parent">
                                <button type="submit" class="" style="background: transparent"><span>NACIONAIS</span>
                                </button>
                            </a>
                        </form>
                    </div>
                ...
                <li>
                    <div class="m-l-20 m-r-20">
                        <form action="search" method="get">
                            ...
                            <a class="parent">
                                <button type="submit" class="" style="background: transparent"><span>IMPORTADOS</span>
                                </button>
                            </a>
                        </form>
                    </div>
                ...
                <li>
                    <div class="m-l-20 m-r-20">
                        <form action="search" method="get">
                            ...
                            <a class="parent">
                                <button type="submit" class="" style="background: transparent"><span>N&Atilde;O-FIC&Ccedil;&Atilde;O</span>
                                </button>
                            </a>
                        </form>
                    </div>
                        ...
                        <form action="search" method="get">
                            ...
                            <a class="parent">
                                <button type="submit" class="" style="background: transparent">
                                    <span>DID&Aacute;TICOS</span></button>
                            </a>
                        </form>
                    </div>
                </li>
                <li>
                    <div class="m-l-20 m-r-20">
                        <a href="about.jsp">
                            <button type="button" style="background: transparent"><span>SOBRE N&Oacute;S</span></button>
                        </a>
                    </div>
                </li>
            </ul>
            ...
            <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/register">
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="password" class="form-control" id="input-password"
                                   ...
                                   name="password"
                                   value="<%out.print(ac.getPassword() != null ? ac.getPassword() : "");%>">
                        </div>
                    </div>
                    <div class="form-group required">
                ...
                <fieldset id="address">
                    ...
                    <p>&Eacute; necess&aacute;rio cadastrar pelo menos um endere&ccedil;o para entrega e cobran&ccedil;a.
                        Se desejar que sejam diferentes, insira um segundo endere&ccedil;o.</p>
                    <%
                        int max = 1;
                    ...
                    <div class="form-group">
                        ...
                        <input type="checkbox" class="col-sm-2" id="isDelivery0" name="address[0][isDelivery]"
                               <%out.print(a.getIsDelivery() != null && a.getIsDelivery() ? "checked" : "");%>>
                        <label class="col-sm-2 control-label text-right" for="isBilling0">Cobran&ccedil;a?</label>
                        <input type="checkbox" class="col-sm-2 text-right" id="isBilling0" name="address[0][isBilling]"
                               <%out.print(a.getIsBilling() != null && a.getIsBilling()? "checked" : "");%>>
                        <label class="col-sm-2 control-label text-right" for="isMain0">Principal?</label>
                        <input type="checkbox" class="col-sm-2 text-right" id="isMain0" name="address[0][isMain]"
                               <%out.print(a.getIsMain() != null && a.getIsMain() ? "checked" : "");%>>
                    </div>
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1 text-center">
                            <a href="#" onclick="window.open('resources/image/Credit-Card-CVV.png');return false;">
                ...
                <div class="buttons">
                    <div class="pull-right">Eu li e concordo com os <a class="agree" href="#"><b>Termos e Condi&ccedil;&otilde;esde Uso</b></a>
    ...
    jQuery(document).ready(function ($) {
        ...
        $(addCard).click(function () {
            var cardFieldHTML = '<hr/><div id="card-form" class="m-t-40">\n' +
                ...
                '<label class="col-sm-2 control-label" for="cardName0">Nome do Titular</label>\n' +
                '<div class="col-sm-8">\n' +
                '<input type="number" class="form-control" id="cardName0" name="card[' + cardCounter + '][name]"\n' +
                'placeholder="Exatamente como aparece no cart&atilde;o">\n' +
                '</div>\n' +
                '<label class="col-sm-1 control-label text-right" for="isMainCard0"> Principal?</label>\n' +
        ...
        var countryOptions = '<option value=""> --- Selecione --- </option>' +
