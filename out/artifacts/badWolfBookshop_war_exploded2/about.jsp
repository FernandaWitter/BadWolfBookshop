                    ...
                    <div class="top-left pull-left">
                        ...
                        <div class="currency">
                            <form action="#" method="post" enctype="multipart/form-data" id="currency">
                                <div class="btn-group">
                                    <button class="btn btn-link dropdown-toggle" data-toggle="dropdown">
                                        <strong>USD</strong> <span class="caret"></span>
                                    </button>
                                    <ul class="dropdown-menu">
                                        <li><a href="#">Real</a></li>
                                        <li><a href="#">USD</a></li>
        ...
        <div class="row m-t-40 text-center">
            <div class="category-page-wrapper">
                <div class="col-sm-4"><img src="resources/image/bookshop-portrait.jpg" alt="Foto do Interior da Livraria
                   Mostrando Dois Andares de Prateleiras &agrave; Direita, com mesas e cadeiras no andar t&eacute;rreo">
                </div>
                <div class="col-sm-8">
                    <h2>A Bad Wolf Bookshop</h2>
                    <br/>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin ac sem tortor. Integer ac mollis
                        diam, nec imperdiet mi. Suspendisse potenti. Aliquam ex risus, lacinia nec nisi quis, consequat
                        ultricies justo. Quisque quis arcu a arcu ultrices condimentum nec ac est. Phasellus ornare
                        risus non velit pellentesque pellentesque. Nam eget volutpat nunc. Curabitur non magna eget est
                        scelerisque suscipit. Morbi sagittis ipsum a viverra bibendum. Proin eros nisi, pellentesque nec
                        sollicitudin et, vulputate sed enim.</p>
                    <p>Integer a commodo elit. Donec vitae sapien enim. Proin congue, eros ac varius auctor, eros elit
                        blandit est, sit amet iaculis odio ipsum eget nibh. Mauris turpis magna, lobortis quis molestie
                        vel, finibus sed ante. Fusce non neque metus. Sed sed urna bibendum, fermentum erat non,
                        tincidunt quam. Vivamus sodales sit amet orci ut porttitor. Aliquam nec erat mi. Nunc
                        ullamcorper sodales neque vel ullamcorper. Proin sed urna ac quam aliquet feugiat id et neque.
                        In vitae erat eleifend, fringilla dolor quis, facilisis mi. Quisque pellentesque consequat justo
                        in laoreet. Phasellus quis lobortis sapien, at feugiat tellus. In hac habitasse platea dictumst.
                        Donec accumsan molestie ante, at maximus odio dictum ut. Maecenas a est eget diam ullamcorper
                        interdum.</p>
                    <p>In aliquet volutpat ante, molestie luctus lorem rhoncus at. Donec nisi quam, gravida a tortor eu,
                        tincidunt mattis neque. Etiam convallis nunc pretium suscipit tincidunt. Praesent pellentesque
                        metus et metus sodales, vel congue nunc varius. Ut sed tincidunt quam. Sed a tellus nisi. Sed
                        feugiat leo orci, sit amet sagittis diam finibus sed. Nam egestas tellus id eros imperdiet, vel
                        volutpat tortor ornare. Quisque ultrices sem accumsan velit maximus venenatis. Cras ut
                        scelerisque massa, id eleifend turpis.</p>
                </div>
            </div>
        </div>
