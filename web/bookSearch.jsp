            ...
            <div class="col-sm-9 col-xs-9 header-right">
                ...
                <div id="cart" class="btn-group btn-block">
                    <a type="button" class="btn btn-inverse btn-block btn-lg cart-dropdown-button" href="${pageContext.request.contextPath}/cart.jsp">
                        <span id="cart-total"><i class="fa fa-shopping-cart" style="color: #189b79;"></i>
                            <span>Carrinho</span>
                            <br/>
                            <%
        ...
        <div class=" content col-sm-9 m-t-40">
            <div class="category-page-wrapper">
                <div class="col-md-2 text-right sort-wrapper">
                    <p>Sua busca por <strong><%out.print(request.getParameter("q"));%></strong> retornou <strong>
                        <%out.print(results.size());%></strong> resultados.</p>
                </div>
            ...
            <div class="grid-list-wrapper">
                    ...
                    <div class="product-thumb">
                        <div class="image product-imageblock m-l-10">
                            <a href="${pageContext.request.contextPath}/book/<%out.print(book.getId());%>">
                                <img src="<%out.print(book.getImagePath());%>" alt="Capa do livro <%out.print(book.getTitle());%>"
                                     title="<%out.print(book.getTitle());%>" style="max-height: 200px;"/>
                                <img src="<%out.print(book.getImagePath());%>" alt="Capa do livro <%out.print(book.getTitle());%>"
                                     title="<%out.print(book.getTitle());%>" style="max-height: 200px;"/>
                            </a>
                        ...
                        <div class="caption product-detail">
                            ...
                            <h4 class="product-name">
                                <a href="#" title="product-name"><%out.print(book.getTitle());%></a>
                            </h4>
                ...
                <div class="text-center">
                    <br/>
                    <p>Sua busca por <strong><%out.print(request.getParameter("q"));%></strong> n&atilde;o retornou
                        nenhum resultado.</p>
                </div>
                <%}%>
            </div>
