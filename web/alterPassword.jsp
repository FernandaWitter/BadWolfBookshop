                        ...
                        <div id="top-links" class="nav pull-right">
                            <ul class="list-inline">
                                ...
                                <li><a href="#" id="wishlist-total" title="Lista de Desejos (0)">
                                    ...
                                    <span>Lista de Desejos</span><span> (0)</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<div class="container">
    <div class="row">
        ...
        <div class="center-block m-l-40 m-r-40" id="content">
            <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/alterPW">
                <p>* Campos obrigat&oacute;rios</p>
                <fieldset>
                    <legend>Altera&ccedil;&atilde;o de Senha</legend>
                    <div class="form-group required">
                        <label for="input-password" class="col-sm-3 control-label">Nova Senha*</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group required">
                        <label for="input-confirm" class="col-sm-3 control-label">Confirme a Senha*</label>
                        <div class="col-sm-9">
