    ...
    <div class="row">
        ...
        <div class="center-block m-l-40 m-r-40" id="content">
            ...
            <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/alterAddress">
                <p>&Eacute; necess&aacute;rio cadastrar pelo menos um endere&ccedil;o para entrega e cobran&ccedil;a. Se desejar,
                    insira endere&ccedil;os adicionais, e poder&aacute; selecion&aacute;-los ao concluir a compra.</p>
                    ...
                    <div id="address<%out.print(i);%>">
                        <legend class="address-label"><%out.print(a.getNickname() != null ? a.getNickname() : "Cadastre um endere&ccedil;o...");%>
                            <button type="button" class="btn btn-danger pull-right" style="height:30px;"
                                    onclick="deleteAddress(<%out.print(i);%>)"><i class="fa fa-remove m-b-20 pt-n2"></i>
                            </button>
                        </legend>
                        ...
                        <div class="form-group required">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control" id="input-zone" name="<%out.print("address[" + i + "][state]");%>">
