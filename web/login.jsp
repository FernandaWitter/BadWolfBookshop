...
<div class="container">
    <div class="row">
        ...
        <div class="center-block top" id="content">
            <div class="row">
                <div class="col-sm-6">
                    <h2>Ainda n&atilde;o tem conta?</h2>
                    <p>Ao se cadastrar, ser&aacute; poss&iacute;vel guardar seus itens preferidos no carrinho para
                        compras posteriores, salvar seus dados pessoais, endere&ccedil;o, e formas de pagamento para
                        agilizar a conclus&atilde;o das compras, visualizar pedidos, e devolver ou trocar produtos.
                        Venha desfrutar destes benef&iacute;cios!</p>
                    <a type="button" value="Cadastrar-se" id="button-account" data-loading-text="Loading..."
                       class="btn btn-primary" href="registration.jsp">Cadastre-se</a>
                </div>
                <div class="col-sm-6">
                    <form method="post" action="${pageContext.request.contextPath}/login">
                        <h2>J&aacute; &eacute; Cliente?</h2>
                        <p>Se voc&ecirc; j&aacute; tem uma conta conosco, basta realizar o login para continuar
                            desfrutando
                            o site!</p>
                        <%
