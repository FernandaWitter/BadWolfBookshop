        ...
        <div class="center-block m-l-40 m-r-40" id="content">
            ...
            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="register.html">
                ...
                <fieldset id="address">
                    ...
                    <p>&Eacute; necess&aacute;rio cadastrar pelo menos um endere&ccedil;o para entrega e cobrança. Se
                    ...
                    <div class="form-group">
                        <div class="text-right">
                            <button class="btn btn-primary">Acrescentar Endere&ccedil;o</button>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="newslatter">
                <form>
                    ...
                    <h4 class="title-subline">Receba todas as novidades, promo&ccedil;&otilde;es, e eventos diretamente
